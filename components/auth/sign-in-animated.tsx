  ...
  return (
    <div className="relative w-full max-w-lg">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card/95 backdrop-blur-xl shadow-2xl">
        ...
        <div className="relative h-40 bg-gradient-to-br from-primary/10 via-background to-accent/10 overflow-hidden">
            ...
            <div className="space-y-2">
              ...
              <div className={cn(
                ...
                <div className="relative">
                  ...
                  >
                    {showPassword ? (
                      <EyeOff className="h-5 w-5 text-muted-foreground transition-transform hover:scale-110" />
                    ) : (
                      <Eye className="h-5 w-5 text-muted-foreground transition-transform hover:scale-110" />
                    )}
                  </Button>
                </div>
              </div>
